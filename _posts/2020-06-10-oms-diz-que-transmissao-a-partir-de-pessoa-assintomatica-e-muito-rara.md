...
Ouvimos de vários países que um número X, um percentual X deles é reportado como não tendo sintomas ou que eles estão em sua fase pré-sintomática, o que significa que estão a alguns dias antes que eles realmente desenvolvam sintomas graves. Em vários países, quando voltamos e discutimos com eles, um: como esses casos assintomáticos estão sendo identificados? Muitos deles estão sendo identificados por meio do rastreamento de contatos, que é o que gostaríamos de ver: você tem um caso conhecido, você busca seus contatos, eles já estão em quarentena, com sorte, e alguns deles são testados. E então você percebe pessoas que podem ser assintomáticos, não ter sintomas ou mesmo ter sintomas leves.
